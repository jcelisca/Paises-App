...
export class Convert {
  public static toRESTCoutriesResponse(json: string): Pais[] {
      return cast(JSON.parse(json), a(r("RESTCoutriesResponse")));
  }

  public static rESTCoutriesResponseToJson(value: Pais[]): string {
      return JSON.stringify(uncast(value, a(r("RESTCoutriesResponse"))), null, 2);
  }
}
